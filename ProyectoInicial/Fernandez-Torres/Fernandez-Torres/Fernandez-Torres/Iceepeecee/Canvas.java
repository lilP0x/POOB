...
public class Canvas{
    ...
    public void setVisible(boolean visible){
        ...
        /**
     * Draw a given shape onto the canvas with a specified color.
     * @param referenceObject  an object to define identity for this shape
     * @param color            the color of the shape
     * @param shape            the shape object to be drawn on the canvas
     */
    public void draw(Object referenceObject, Color color, Shape shape, int alpha) {
    ...
    public void setForegroundColor(Color color, int alpha){
    ...
    public void setForegroundColor(String colorString,int alpha){
        if(colorString.equals("red")){
            ...
            graphic.setColor(new Color(rgb[0],rgb[1],rgb[2],alpha));
        }
        else if(colorString.equals("black")){
    ...
    private int[] colorRgb(Color color) {
        int red = color.getRed();
        int green = color.getGreen();
    ...
    private class ShapeDescription{
        ...
        public ShapeDescription(Shape shape, Color color, int alpha) {
            this.shape = shape;
            this.color = color;
            this.alpha = alpha;
        }
        public void draw(Graphics2D graphic){
            if (!colorString.substring(0, 3).equals("RGB")){
                setForegroundColor(colorString,alpha);
                graphic.draw(shape);
                graphic.fill(shape);
            }
            else{
                Color color = new ColorPropio(colorString).traductor();
                setForegroundColor(color,alpha);
                graphic.draw(shape);
                graphic.fill(shape);
            }
        } 
